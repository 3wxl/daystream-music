...
import LyricSolitaire from '../components/MusicGame/LyricSolitaire.vue'
import GuessSong from '../components/MusicGame/GuessSong.vue'
import GuessAuthor from '../components/MusicGame/GuessAuthor.vue'
