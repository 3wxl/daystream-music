  ...
  <div>
    <div class="shadow-md/4 border-[#e4e7ed] bg-white rounded-[10px] p-[15px]">
      <div class="flex justify-between px-4 items-center">
        <div class="flex items-center h-full">
          ...
          <AdminSelect class="mr-16" v-model="typeVal" :options="[{value:'1',label:'歌曲'},{value:'2',label:'歌单'},{value:'3',label:'动态'}]" label="类型" ></AdminSelect>
    ...
    <div class="shadow-md/4 border-[#e4e7ed] bg-white rounded-[10px] p-[15px] mt-3">
      ...
      <div class="user-table w-full mt-4">
        <el-table :data="typeVal==='1'?commentsListSongs:typeVal==='2'?commentsListGD:commentsListDynamic" stripe >
          ...
          <el-table-column :label="typeVal==='1'?'评论歌曲':typeVal==='2'?'评论歌单':'评论动态'" width="320" align="center">
            <template #default="scope">
