        ...
        <el-table :data="dynamicList" stripe >
          ...
          <el-table-column label="标题" width="250" align="center" class="relative">
            <template #default="scope">
              <span class="line-clamp-1 cursor-pointer text-[15px] hover:text-[#529FFD] duration-300" @click="router.push('/admin/communityManage/DynamicDetail')">{{ scope.row.title }}</span>
            </template>
          </el-table-column>
          <el-table-column label="内容" width="220" align="center" class="relative">
            <template #default="scope">
              <span class="line-clamp-1 cursor-pointer hover:text-[#529FFD] duration-300"  @click="router.push('/admin/communityManage/DynamicDetail')">{{ scope.row.content }}</span>
            </template>
          </el-table-column>
