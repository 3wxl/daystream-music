<template>
  <div class="max-w-7xl mx-auto px-4 py-6">
    <UserHeader :userInfo="musicianInfo" :isOthersPage="false" />

    <div
      class="mt-8 w-full max-w-full mx-auto bg-[#1a1a2e] rounded-3xl p-3 shadow-[0_4px_20px_rgba(0,0,0,0.3)]"
    >
      <div class="tabs relative flex h-16 items-center">
        <button
      ...
      <div class="tab-content mt-5 p-5 text-white min-h-[100px]">
        ...
        >
          <h3 class="mt-0 mb-4 text-lg font-semibold text-gray-100 pl-3 border-l-3 border-pink-500">
            我的作品
          </h3>
        ...
        >
          ...
          <div
            class="collection-albums-page bg-[#0808127d] text-white font-['Poppins',sans-serif] overflow-x-hidden rounded-2xl"
          >
...
if (typeof window !== 'undefined') {
  const tailwindConfig = {
    theme: {
      extend: {
        transitionProperty: {
          'tab-indicator': 'all 0.3s cubic-bezier(0.25, 0.8, 0.25, 1)',
          'tab-button': 'color 0.2s ease, transform 0.2s ease',
        },
      },
    },
    plugins: [
